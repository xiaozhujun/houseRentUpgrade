    ...
    <div id='headContainer'>
    	...
    	<div id='headRightDiv'>
    		...
    		<div id='headBottomDiv'>
    			<div id='loginRegDiv'>
    			{if isset($user)}
    				hi,<a href='/User/personCenter'><?php echo ($user); ?></a>&nbsp;<a href='/User/logout'>安全退出</a>
    			{else}
    				...
    				<div id='intention'>
    					<div class='intentionRowDiv'>
    						...
    						<div class='intentionInputDiv'>
    							<input id='companyInput' oldVal="<?php echo ($companyName); ?>" value="<?php echo ($companyName); ?>" class='intentionInput' type='text' data-empty='推荐你同事的房源信息'>
    					...
    					<div class='intentionRowDiv'>
    						...
    						<div class='intentionInputDiv'>
    							<input id='collegeInput' oldVal="<?php echo ($collegeName); ?>" value="<?php echo ($collegeName); ?>" class='intentionInput' type='text' data-empty='推荐你校友的房源'>
    					...
    					<div class='intentionRowDiv'>
    						...
    						<div class='intentionInputDiv'>
    							<input id='targetHouseInput' oldVal="<?php echo ($communityName); ?>" value="<?php echo ($communityName); ?>" class='intentionInput' type='text' data-empty='推荐意向居住地的房源'>
